Incivent_App::Application.configure do
  # Settings specified here will take precedence over those in config/application.rb

  # Use the Heroku SSL certificate for now
  ...
  config.action_mailer.default_url_options = { :host => 'http://impactready.herokuapp.com' }
