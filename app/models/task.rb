class Task < ActiveRecord::Base
  ...
  attr_accessible :description, :raised_user_id, :assigned_user_id, :group_id, :latitude, :longitude, :location, :priority_id, :status_id, :due_date, :complete, :task_image, :archive
